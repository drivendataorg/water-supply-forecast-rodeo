...
if __name__ == "__main__":
    ...
    path = "data/external/usgs_streamflow/"
    os.makedirs(path, exist_ok=True)
    download_usgs(usgs_list, start_date="1900-01-01", end_date="2023-10-21", path=path)
    download_usgs(usgs_list[0:10], data_type="monthly", output_name="raw1", path=path)
    download_usgs(usgs_list[10:20], data_type="monthly", output_name="raw2", path=path)
    download_usgs(usgs_list[20:], data_type="monthly", output_name="raw3", path=path)
