...
def generate_acis_deviation(preprocessed_dir: Path,
    ...
    acis_precip.to_csv(preprocessed_dir / "train_acis_precip.csv", index=False)
    ...
    precip_deviation = precip_deviation.sort_values(['site_id', 'date'])
    ...
    acis_temp.to_csv(preprocessed_dir / "train_acis_temp.csv", index=False)
