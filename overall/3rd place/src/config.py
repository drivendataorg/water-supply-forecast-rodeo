...
# External path
SNOTEL_SWE_DIR = "data/external/snotel"
CDEC_SWE_DIR = "data/external/cdec"
USGS_DIR = "data/external/usgs_streamflow"
USBR_DIR = "data/external/usbr"
PDSI_DIR = "data/external/pdsi"
UASWANN_DIR = "data/external/uaswann"
ERA5_DIR = "data/external/era5"
SEAS51_DIR = "data/external/seas51"
...
td_usgs_sites = [
    ...
    # "snake_r_nr_heise" # removed because low ratio and correlation between volume and volume_obs
]
