...
def train_models(data, random_state, n_splits=10):
    ...
    Returns:
        dict: Trained models and conformal prediction adjustments.
    """
    ...
    return {'models': final_models, 'cp_adjustments': cp_adjustments}
...
def main():
    ...
    for train_indices, test_indices in logo.split(loocv_data.volume.values, groups=loocv_data.forecast_year):
        ...
        predictions = predict_models(results['models'], test_data, results['cp_adjustments'])
