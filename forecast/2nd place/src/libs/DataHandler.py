...
class DataHandler:
    ...
    def train_data(self) -> pd.DataFrame:
        df = pd.read_csv(os.path.join(self.base_dir, 'forecast_train.csv')).dropna()
    ...
    def train_monthly_flow(self) -> pd.DataFrame:
        df = pd.read_csv(os.path.join(self.base_dir, 'forecast_train_monthly_naturalized_flow.csv')).dropna()
        return df
